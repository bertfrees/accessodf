              ...
              com.sun.star.frame.XDispatchProvider
{
    ...
    private static final String m_implementationName = AccessibilityCheckerAddOn.class.getName();
    ...
    public AccessibilityCheckerAddOn( XComponentContext context )
    {
        m_xContext = context;
    ...
    public static XSingleComponentFactory __getComponentFactory( String sImplementationName ) {
        ...
        if ( sImplementationName.equals( m_implementationName ) )
            xFactory = Factory.createComponentFactory(AccessibilityCheckerAddOn.class, m_serviceNames);
        return xFactory;
    }
